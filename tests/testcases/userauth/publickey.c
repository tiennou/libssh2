...
void test_userauth_publickey__auth_fails_with_wrong_key(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), WRONG_KEYFILE_PUBLIC, WRONG_KEYFILE_PRIVATE,
        NULL);
...
void test_userauth_publickey__dsa_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), DSA_KEYFILE_PUBLIC, DSA_KEYFILE_PRIVATE,
        NULL);
...
void test_userauth_publickey__ed25519_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), ED25519_KEYFILE_PUBLIC, ED25519_KEYFILE_PRIVATE,
        NULL);
...
void test_userauth_publickey__ed25519_mem_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_frommemory(session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME),
...
void test_userauth_publickey__ed25519_encrypted_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), ED25519_KEYFILE_ENC_PUBLIC,
...
void test_userauth_publickey__rsa_encrypted_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), RSA_KEYFILE_ENC_PUBLIC,
...
void test_userauth_publickey__rsa_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), RSA_KEYFILE_PUBLIC, RSA_KEYFILE_PRIVATE,
        NULL);
...
void test_userauth_publickey__rsa_openssh_auth_ok(void)
{
    ...
    rc = libssh2_userauth_publickey_fromfile_ex(
        session, OPENSSH_USERNAME, strlen(OPENSSH_USERNAME), RSA_OPENSSH_KEYFILE_PUBLIC,
